report 50005 "NGL - Proforma Invoice(Export)"
{
    // version KAR1.0

    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\NGL - Proforma Invoice(Export).rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            //Export Document=CONST(Yes)); //PCPL-Deepak
            ...
            column(Buyer_Ecc_No; '')//RecCustomer."E.C.C. No.")
            {
            }
            column(Buyer_Tin_No; '')// RecCustomer."T.I.N. No.")
            {
            }
            ...
            column(Final_Destination; '')//"Sales Header"."Final Destination")
            {
            }
            column(Place_Discharge; '')//"Sales Header"."Port of Discharge")
            {
            }
            ...
            column(Company_CE_Reg_No; '')//CompanyInfo."C.E. Registration No.")
            {
            }
            column(Range; '')//CompanyInfo."C.E. Range")
            {
            }
            column(Division; '')//CompanyInfo."C.E. Division")
            {
            }
            column(Commision_Rate; '')//CompanyInfo."C.E. Commissionerate")
            {
            }
