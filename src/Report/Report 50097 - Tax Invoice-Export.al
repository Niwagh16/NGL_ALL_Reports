report 50097 "Tax Invoice-Export"
{
    // version NAVW19.00.00.48466,NAVIN9.00.00.48466

    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\Tax Invoice-Export.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(LocToAddress; LocationAdd.Address + ' ' + LocationAdd."Address 2" + ' ' + LocationAdd.City + ' ' + LocationAdd."State Code")
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(DirectDebitPLARG_SalesInvLine; '') //"Direct Debit To PLA / RG") //PCPL-Deepak
                        {
                        }
                        ...
                        begin
                            ...
                            IF IsGSTApplicable AND (Type <> Type::" ") THEN BEGIN
                                ...
                                //     REPEAT
                                //         GSTComponentCode[J] := GSTComponent.Code; //PCPL/NSW/MIG 09Aug22
                            ...
                            IF recDetailedGSTLedger.FINDSET THEN
                                ...
                                UNTIL recDetailedGSTLedger.NEXT = 0;
                            GSTBaseAmt := 0; //"GST Base Amount"; //PCPL-Deepak
                        ...
                        begin
                            ...
                            //CurrReport.CREATETOTALS("Line Amount", Amount, "Amount Including VAT", "Inv. Discount Amount", "Excise Amount", "Tax Amount", //PCPL-Deepak
            ...
            begin
                ...
                END;
                //  FormatAddr.SalesInvShipTo(ShipToAddr, "Sales Invoice Header"); //PCPL/NSW/MIG 09Aug22
                ...
                IF ShipToPost.GET("Sales Invoice Header"."Ship-to Code") THEN BEGIN
