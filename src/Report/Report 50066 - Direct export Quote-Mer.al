report 50066 "Direct export Quote-Mer"
{
    // version KAR1.0

    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\Direct export Quote-Mer.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            // "Export Document" = CONST(true)); //PCPL/NSW/MIG 09Aug22
            ...
            column(Final_Destination; '')//"Sales Header"."Final Destination") //PCPL/NSW/MIG 09Aug22
            {
            }
            ...
            column(Ship_Address; "Sales Header"."Bill-to Address" + ',' + "Sales Header"."Bill-to Address 2" + ',' + "Sales Header"."Bill-to City" + ',' + "Sales Header"."Sell-to Post Code")
            {
            }
            ...
            column(Drug_License_No; CompanyInfo."Drug License No.")
            {
            }
            ...
            column(ShipmentLocatin_Druglicenseno; RecLocation."Drug license No.")
            {
            }
            column(Location_ECCNo; 0)//RecLocation."E.C.C. No.") //PCPL/NSW/MIG 09Aug22
            {
            }
            column(Location_Range; 0)// RecLocation."C.E. Range")//PCPL/NSW/MIG 09Aug22
            {
            }
            column(Location_Commissionerate; 0)// RecLocation."C.E. Commissionerate") //PCPL/NSW/MIG 09Aug22
            {
            }
            column(Location_Division; 0)//RecLocation."C.E. Division") //PCPL/NSW/MIG 09Aug22
            {
            }
            column(PortName; PortName)
            {
            }
            column(OverseaseBank_Details; "Sales Header"."Overseas Bank Details")
            {
            }
            ...
            dataitem("<Sales Line>"; "Sales Line")
            {
                ...
                column(Tax_Amount; 0)//"Tax Amount")//PCPL/NSW/MIG 09Aug22
                {
                }
                ...
                column(Service_Tax_Shess_Amount; 0)//"Service Tax SHE Cess Amount")
                {
                }
    ...
    var
        ...
        Head_Off_CaptionLbl: Label 'HO (Sales Office): 2 New Metalage Indl Premises, Subhash Road, Jogeshwari East, Mumbai 400060';
        TelNo_CaptionLbl: Label 'Tel.: (+91 22) 40539999 Fax: (+91 22) 40539900 Email: info@nglfinechem.com';
        RegOff_CaptionLbl: Label 'Regd Office: W142C TTC MIDC Industrial Area, Pawane, Thane Belapur Road, Navi Mumbai 400705';
