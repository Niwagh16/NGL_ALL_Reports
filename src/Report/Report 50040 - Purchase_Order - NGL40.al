report 50040 "Purchase_Order - NGL40"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(Purchase_Comments; Comments[1])
            {
            }
            ...
            dataitem(pageLoop; Integer)
            {
                ...
                dataitem("Purchase Line"; "Purchase Line")
                {
                    ...
                    column(Purchase_Line_Specification_Description; "Purchase Line".Description)
                    {
                    }
    ...
    var
        ...
        ven: Record Vendor;
        gcont: Text[30];
        Comments: array[100] of Text[400];
