report 50002 "NGL - Order Confirmation"
{
    // version KAR1.0

    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\NGL - Order Confirmation.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(GSTINBuy; RecCustomer."GST Registration No.")
            {
            }
            ...
            column(Buyer_CST_No; '')//RecCustomer."C.S.T. No.") //PCPL/NSW/MIG 01Aug22
            {
            }
            column(PANNoBuy; RecCustomer."P.A.N. No.")
            {
            }
            ...
            column(Ship_Name; "Sales Header"."Ship-to Name")
            {
            }
            column(Ship_Address; "Sales Header"."Ship-to Address")
            {
            }
            column(Ship_Address_b; "Sales Header"."Ship-to Address 2")
            {
            }
            ...
            column(GSTINCom; CompanyInfo."GST Registration No.")
            {
            }
            ...
            column(Location_ECC_No; '')//RecLocation."E.C.C. No.")//PCPL/NSW/MIG 01Aug22
            {
            }
            ...
            column(Form_Code; '')//"Sales Header"."Form Code") //PCPL/NSW/MIG 01Aug22
            {
            }
            ...
            dataitem("<Sales Line>"; "Sales Line")
            {
                ...
                column(Tax_Amount; '')// "Tax Amount")- //PCPL/NSW/MIG 01Aug22
                {
                }
                column(Excise_Amount; '')// "Excise Amount") //PCPL/NSW/MIG 01Aug22
                {
                }
                column(Service_tax_Amount; '')// "Service Tax Amount") //PCPL/NSW/MIG 01Aug22
                {
                }
                column(Service_tax_excess_Amount; '')//"Service Tax eCess Amount") //PCPL/NSW/MIG 01Aug2
                {
                }
                column(Service_Tax_Shess_Amount; '')//"Service Tax SHE Cess Amount") //PCPL/NSW/MIG 01Aug22
                {
                }
                column(TCS_Amount; '')//"Total TDS/TCS Incl. SHE CESS") //PCPL/NSW/MIG 01Aug22
                {
                }
                ...
                begin
                    /* StructureLineDetails.RESET;
                     ...
                     IF StructureLineDetails.FIND('-') THEN
                         REPEAT
                             ...
                             END;
                         UNTIL StructureLineDetails.NEXT = 0;*///PCPK-Deepak
                    ...
                    CGSTAmt := 0;
                    DGEB.RESET;
                    DGEB.SETRANGE(DGEB."Document No.", "<Sales Line>"."Document No.");
                    DGEB.SETRANGE(DGEB."Transaction Type", DGEB."Transaction Type"::Sales);
                    DGEB.SETRANGE(DGEB."Document Type", DGEB."Document Type"::Order);
                    //DGEB.SETRANGE(DGEB."Line No.","<Sales Line>"."Line No.");
                    //DGEB.SETRANGE(DGEB."Document Type","<Sales Line>"."Document Type"::Order);
                    IF DGEB.FINDSET THEN
                        ...
                        UNTIL DGEB.NEXT = 0;
                    //PCPL 38
                    vTCSAmt += 0; //"<Sales Line>"."TDS/TCS Amount"; //PCPK-Deepak
                    vTcsPer := 0; //"<Sales Line>"."TDS/TCS %"; //PCPK-Deepak
                    //PCPL 38
                end;
            }
            ...
            begin
                ...
                /* FormTable.RESET;
                 FormTable.SETRANGE(FormTable.Code,"Sales Header"."Form Code");

                 IF PaymentTerms.GET("Sales Header"."Payment Terms Code")  THEN;

                 IF FormTable.FINDFIRST THEN
                 formdescription :=FormTable.Description;*/ //PCPC-Deepak
