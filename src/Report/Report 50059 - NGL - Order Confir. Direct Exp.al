report 50059 "NGL - Order Confir. Direct Exp"
{
    // version KAR1.0

    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\NGL - Order Confir. Direct Exp.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(Buyer_Ecc_No; '')//RecCustomer."E.C.C. No.") PCPL/NSW/MIG 09Aug22
            {
            }
            column(Buyer_Tin_No; '')// RecCustomer."T.I.N. No.") PCPL/NSW/MIG 09Aug22
            {
            }
            column(Consignee_Name; "Sales Header"."Ship-to Name" + ' ' + "Sales Header"."Ship-to Name 2")
            {
            }
            ...
            column(Final_Destination; RecCountry.Name)
            {
            }
            column(Place_Discharge; '')//"Sales Header"."Port of Discharge") PCPL/NSW/MIG 09Aug22
            {
            }
            column(Country_Of_Origin; '')// "Sales Header"."Country of Origin of Goods") PCPL/NSW/MIG 09Aug22
            {
            }
            ...
            column(Ship_City; "Sales Header"."Ship-to City" + ', ' + "Sales Header"."Ship-to Post Code")
            {
            }
            ...
            column(Delivery_Term; "Sales Header"."Delivery Terms")
            {
            }
            column(DescriptionPaymentTerms; PaymentTerms.Description)
            {
            }
            column(CountryofFinalDestination_SalesHeader; RecCountry.Name)
            {
            }
            column(Country_Of_Final_Destination; ShipCountryName)
            {
            }
            ...
            column(Company_CE_Reg_No; '')//CompanyInfo."C.E. Registration No.") PCPL/NSW/MIG 09Aug22
            {
            }
            ...
            column(Commision_Rate; '')//CompanyInfo."C.E. Commissionerate") PCPL/NSW/MIG 09Aug22
            {
            }
            ...
            column(Location_ECC_No; '')//RecLocation."E.C.C. No.") PCPL/NSW/MIG 09Aug22
            {
            }
            ...
            column(IECCODE_No; CompanyInfo."IEC CODE No.")
            {
            }
            ...
            dataitem("<Sales Line>"; "Sales Line")
            {
                ...
                column(Tax_Amount; 0)//"Tax Amount") "Document Type="field("Document Type"), PCPL/NSW/MIG 09Aug22
                {
                }
                column(Excise_Amount; 0)//"Excise Amount") PCPL/NSW/MIG 09Aug22
                {
                }
                column(Service_tax_Amount; 0)//"Service Tax Amount") PCPL/NSW/MIG 09Aug22
                {
                }
                column(Service_tax_excess_Amount; 0)//"Service Tax eCess Amount") PCPL/NSW/MIG 09Aug22
                {
                }
                column(Service_Tax_Shess_Amount; 0)//"Service Tax SHE Cess Amount") PCPL/NSW/MIG 09Aug22
                {
                }
                column(TCS_Amount; 0)//"Total TDS/TCS Incl. SHE CESS") PCPL/NSW/MIG 09Aug22
                {
                }
            ...
            begin
                ...
                ELSE
                    CountryName := ' ';
                //  IF RecCountry.GET("Sales Header"."Country of Final Destination") THEN;
                // BankAccount.RESET;
                ...
                */
                //PCPL-25
                IF "Sales Header"."Currency Code" <> 'EURO' THEN BEGIN
                    Strpos_ := STRPOS(BankAccount."correspondence Bank", '2)');
                    Strpos_1 := STRPOS(BankAccount."correspondence Bank", '1)');
                    Corresp := COPYSTR(BankAccount."correspondence Bank", 1, Strpos_1 - 1);
                    Corresp1 := COPYSTR(BankAccount."correspondence Bank", Strpos_1, Strpos_ - Strpos_1);
                ...
                END
                ELSE BEGIN
                    IF BankAccount."Correspondence Bank For Euro" <> '' THEN BEGIN
                        Strpos_ := STRPOS(BankAccount."Correspondence Bank For Euro", '2)');
                        Strpos_1 := STRPOS(BankAccount."Correspondence Bank For Euro", '1)');
                        IF Strpos_1 <> 0 THEN BEGIN
                            Corresp := COPYSTR(BankAccount."Correspondence Bank For Euro", 1, Strpos_1 - 1);
                            Corresp1 := COPYSTR(BankAccount."Correspondence Bank For Euro", Strpos_1, Strpos_ - Strpos_1);
                            Corresp2 := COPYSTR(BankAccount."Correspondence Bank For Euro", Strpos_);
                        END
                        ELSE
    ...
    var
        ...
        CountryOr_CaptionLbl: Label 'Country of Origin';
