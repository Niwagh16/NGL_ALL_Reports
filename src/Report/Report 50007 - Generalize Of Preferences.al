// report 50007 "Generalize Of Preferences"
// {
//     // version PCPL-NS
//     /*
//     DefaultLayout = RDLC;
//     RDLCLayout = 'src/Generalize Of Preferences.rdl';
...
//             {
//             }
//             column(Description_Transction; TransctionCode.Description)
//             {
//             }
//             column(noo; "No.")
//             {
...
//             {
//             }
//             column(Company_IEC; 'IEC CODE :' +'')// CompanyInfo."I.E.C. Code") //PCPL/NSW/MIG  03Aug22
//             {
//             }
//             column(IEC_CodeNo; 'IEC CODE :' + CompanyInfo."IEC CODE No.")
//             {
//             }
...
//                 {
//                 }
//                 column(FOBINR_SalesLine;0)//FORMAT("Sales Line"."FOB (INR)")) //PCPL/NSW/MIG  03Aug22
//                 {
//                 }
//                 column(FOBUSD_SalesLine; 0)//'FOB VALUES USD' + FORMAT("Sales Line"."FOB (USD)")) //PCPL/NSW/MIG  03Aug22
//                 {
//                 }
//                 column(Srno; SrNo)
//                 {
...
//                 IF TransctionCode.GET("Transaction Type") THEN;
//                 i := 0;
//                 SalesCommment.RESET;
