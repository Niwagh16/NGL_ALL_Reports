report 50098 "ExporInvoice-GST"
{
    // version PCPL-NS

    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\ExporInvoice-GST.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(TermsOfDelivery; 'INCOTERMS :' + ' ') //+"Sales Invoice Header".Incoterms) //PCPL-Deepak
            {
            }
            column(APYMETN; FORMAT(PaymentMethodCode.Description))
            {
            }
            column(Port; '') //"Sales Invoice Header".Port) //PCPL-Deepak
            {
            }
            column(PortDischarge; '') //"Sales Invoice Header"."Port of Discharge") //PCPL-Deepak
            {
            }
            column(Name; Customer.Name)
            {
            }
            column(vesselflightno; 0) //"Sales Invoice Header"."Vessel/Flight No.") //PCPL-Deepak
            {
            }
            column(finaldestination; '') //"Sales Invoice Header"."Final Destination") //PCPL-Deepak
            {
            }
            column(Countryoforiginofgoods; '') //"Sales Invoice Header"."Country of Origin of Goods") //PCPL-Deepak
            {
            }
            column(Countryofffinaldestination; 0) //"Sales Invoice Header"."Country of Final Destination") //PCPL-Deepak
            {
            }
            column(ExportShipmentType_SalesInvoiceHeader; '') //"Sales Invoice Header"."Export Shipment Type") //PCPL-Deepak
            {
            }
            column(DrugLicno; 0) //LocationAdd."Drug license No.") //PCPL-Deepak
            {
            }
            column(NAMECOUNTRY; Country.Name)
            {
            }
            column(IECCodeno; '') //CompanyInfo."IEC CODE No.")//PCPL-Deepak
            {
            }
            ...
            column(ENDUSe; '') //CompanyInfo."END Use Code") //PCPL-Deepak
            {
            }
            ...
            column(Cinmail;/*CompanyInfo."Company Registration  No."+*/ ', E-mail : ' + CompanyInfo."E-Mail" + ', Tel: ' + CompanyInfo."Phone No.") //PCPL-Deepak
            {
            }
            ...
            column(PortofDischarge; '')//ecPort."Port Name")
            {
            }
            column(LineAmtusd; LineAmtusd)
            {
            }
            column(Incoterms_SalesInvoiceHeader; '') //"Sales Invoice Header".Incoterms) //PCPL-Deepak
            {
            }
            ...
            column(PortName; '')// portrec1."Port Name")
            {
            }
            column(totIGSTAmt; IGSTAMT_)
            {
            }
            column(No_SalesInvHdr; "No.")
            {
            }
            column(ElectronicReferenceNo_SalesInvoiceHeader; 0) //"Sales Invoice Header"."Electronic Reference No.") //PCPL-Deepak
            {
            }
            ...
            column(PONoNDate; '') //"Sales Invoice Header"."Buyer Reference No.1") //PCPL-Deepak
            {
            }
            column(DateNtimeofRemoval;/*FORMAT("Sales Invoice Header"."Date Sent")+*/' ' + FORMAT("Sales Invoice Header"."Time of Removal")) //PCPL-Deepak
            {
            }
            ...
            column(LineAmtUSDWord; LineAmtUSDWord[1])
            {
            }
            ...
            column(LUTNO; '') //"Sales Invoice Header"."Form No.") //PCPL-Deepak
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(BillToCustNo_SalesInvHdrCaption; TotalGross)
                    {
                    }
                    column(PricesInclVAT_SalesInvHdrCaption; TotalNet)
                    {
                    }
                    column(AmtWords; AmtWords[1] + '  ' + AmtWords[2])
                    {
                    }
                    column(AmtWordsCGS; 'CGST Amount in Words :' + AmtWordsCGS[1] + '  ' + AmtWordsIGS[2])
                    {
                    }
                    column(AmtWordsSGS; 'SGST Amount in Words :' + AmtWordsSGS[1] + '  ' + AmtWordsIGS[2])
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(TotalGSTAmount_SalesInvoiceLine; 0) //ROUND("Sales Invoice Line"."Total GST Amount"*decCurrencyFactor,0.01)) //PCPL-Deepak
                        {
                        }
                        ...
                        column(AmtInclVAT_SalesInvLine; 0) //ROUND("Amount To Customer"*decCurrencyFactor,0.01)) //PCPL-Deepak
                        {
                            AutoFormatExpression = "Sales Invoice Line".GetCurrencyCode;
                            AutoFormatType = 1;
                        }
                        ...
                        dataitem("Value Entry"; "Value Entry")
                        {
                            ...
                            dataitem("Item Ledger Entry"; "Item Ledger Entry")
                            {
                                ...
                                begin
                                    ...
                                    // PackingListPackageDetails.SETRANGE(PackingListPackageDetails."Lot Number", "Item Ledger Entry"."Lot No.");
                                    // IF PackingListPackageDetails.FINDFIRST THEN;
                                    ...
                                    // IF PackingListPackage.FINDLAST THEN BEGIN
                        ...
                        begin
                            ...
                            IF PackingList.FINDFIRST THEN BEGIN
                              ...
                              PackingListPackage.SETRANGE(PackingListPackage."Item No.","Sales Invoice Line"."No.");
                            ...
                            */
                            ...
                            IF DetailedGSTLedgerEntry.FINDSET THEN BEGIN
                                REPEAT
                                    CGSTAMT_ += ABS(DetailedGSTLedgerEntry."GST Amount");
                                    CGSTPer := DetailedGSTLedgerEntry."GST %";
                                    totCGSTAmt += ABS(DetailedGSTLedgerEntry."GST Amount");
                                UNTIL DetailedGSTLedgerEntry.NEXT = 0;
                            END;
                            totCGSTAmt += CGSTAMT_ + totCGSTAmt;
                            DetailedGSTLedgerEntry.RESET;
                            DetailedGSTLedgerEntry.SETRANGE("Transaction Type", DetailedGSTLedgerEntry."Transaction Type"::Sales);
                            DetailedGSTLedgerEntry.SETRANGE("Document Type", recDetailedGSTLedger."Document Type"::Invoice);
                            DetailedGSTLedgerEntry.SETRANGE("Document No.", "Document No.");
                            DetailedGSTLedgerEntry.SETRANGE("Document Line No.", "Line No.");
                            DetailedGSTLedgerEntry.SETRANGE(DetailedGSTLedgerEntry."GST Component Code", 'SGST');
                            IF DetailedGSTLedgerEntry.FINDSET THEN
                                REPEAT
                                    SGSTAMT_ += ABS(DetailedGSTLedgerEntry."GST Amount");
                            ...
                            IF DetailedGSTLedgerEntry.FINDSET THEN
                                REPEAT
                                    IGSTAMT_ += ABS(DetailedGSTLedgerEntry."GST Amount");
                            ...
                            /* StructureLineDetails12.RESET; 
                             ...
                             RCheck.FormatNoText(LineAmtUSDWord,ROUND(LineAmtusd + ChargesAmount),"Sales Invoice Header"."Currency Code");   //PCPL-25
                             //PCPL-25
                    ...
                    dataitem(Integer; Integer)
                    {
                        ...
                        trigger OnPreDataItem();
                        begin
                            SETRANGE(Number, 1, 12 - vTotalCount);
                        end;
                    }
                }
            ...
            begin
                ...
                recSalesHeader.SETRANGE(recSalesHeader."No.", "Sales Invoice Header"."No.");
                IF recSalesHeader.FINDFIRST THEN BEGIN
                    CommPay := recSalesHeader."Currency Code Vendor" + ' ' + FORMAT(recSalesHeader."Vendor Amount");
                    IF (CommPay = '') OR (recSalesHeader."Vendor Amount" = 0) THEN
                        CommPay := 'NA';
                END;
                ...
                //YSR BEGIN
                AmttoCustomer := 0; //"Amount to Customer"; //PCPL-Deepak
                //PCPL-25 31dec20
                ...
                //  IF Country.GET("Sales Invoice Header"."Country of Final Destination") THEN;
                ...
                //
                // IF recPort.GET("Sales Invoice Header"."Port of Discharge") THEN;
                // IF portrec1.GET("Sales Invoice Header".Port) THEN;
                //
                CompanyInfo.GET;
                ...
                IF BillToCust.GET("Bill-to Customer No.") THEN
                    IF CountryRegion.GET(BillToCust."Country/Region Code") THEN; //PCPL/BRB
                ...
                */
                ...
                IF SalesInvLine.FINDSET THEN
                    REPEAT
                        GSTBaseAmt += SalesInvLine."Line Amount";//SalesInvLine."GST Base Amount";
                        LineAmtusd += SalesInvLine."Line Amount";
                        TotalLineAmt += ROUND(SalesInvLine."Line Amount" * decCurrencyFactor, 0.01);   //PCPL-25
                ...
                RCheck.InitTextVariable;
                //RCheck.FormatNoText(LineAmtUSDWord,ROUND(LineAmtusd),"Sales Invoice Header"."Currency Code");   //temp comment
                ...
                // PackingList.SETRANGE("No.", "Sales Invoice Header"."No.");   //PCPL-25
                ...
                IGSTAMT_ := 0;
                DGEB.RESET;
                DGEB.SETRANGE("Document No.", "No.");
                IF DGEB.FINDSET THEN
                    REPEAT
                        IF DGEB."GST Component Code" = 'IGST' THEN BEGIN
                            IGSTAMT_ += ABS(DGEB."GST Amount");
                        END
                        ELSE
                            IF DGEB."GST Component Code" = 'SGST' THEN BEGIN
                                SGSTAMT_ += ABS(DGEB."GST Amount");
                                // SGSTper:=DGEB."GST %";
                            END
                            ELSE
                                IF DGEB."GST Component Code" = 'CGST' THEN BEGIN
                                    CGSTAMT_ += ABS(DGEB."GST Amount");
                                    //CGSTper:=DGEB."GST %";
                                END;
                    UNTIL DGEB.NEXT = 0;
                ...
                RCheck.InitTextVariable;
                RCheck.FormatNoText(AmtWordsCGS, CGSTAMT_, '');
                RCheck.InitTextVariable;
                RCheck.FormatNoText(AmtWordsSGS, SGSTAMT_, '');
                RCheck.InitTextVariable;
                RCheck.FormatNoText(AmtWordsIGS, IGSTAMT_, '');
                AMTIGST := IGSTAMT_;    //PCPL-25 16feb21
    ...
    var
        ...
        NoOfPack: Text;
        PackMark: Text;
        LineAmtUSDWord: array[2] of Text;
        LineAmtusd: Decimal;
        ...
        // portrec1: Record "33001050";
        DGEB: Record "Detailed GST Ledger Entry";
        IGSTAMT_: Decimal;
        CGSTAMT_: Integer;
        SGSTAMT_: Integer;
