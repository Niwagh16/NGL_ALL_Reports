report 50052 "GSP Report onlyprint2page"
{
    // version GSP Report sanjay Final dated 30/04/2015

    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\GSP Report onlyprint2page.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            begin
                ...
                BEGIN
                END;
                //for one column invno and posting date
