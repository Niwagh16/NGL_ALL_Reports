// report 50067 "Pre-Shipment Export Invoice."
// {
//     // version GITLEXIM 6.00.01.03 //PCPL/NSW/MIG 09Aug22

//     DefaultLayout = RDLC;
//     RDLCLayout = 'src\Report Layout\Pre-Shipment Export Invoice..rdl';
...
//             {
//             }
//             column(codPostedInvNo______FORMAT_datPostingDate_0_4_; codPostedInvNo + '     ' + FORMAT(datPostingDate, 0, '<Day>.<Month>.<Year4>'))
//             {
//             }
...
//             {
//             }
//             column(UPPERCASE_txtCountryOfOriginOfGoods_; UPPERCASE(txtCountryOfOriginOfGoods))
//             {
//             }
//             column(UPPERCASE_txtCountryOfFinalDest_; UPPERCASE(txtCountryOfFinalDest))
//             {
//             }
//             column(codVesselNo; "Sales Header"."Vessel/Flight No.")
//             {
//             }
//             column(txtPortOfLoading; "Sales Header".Port)
//             {
//             }
//             column(txtFinalDestination; "Sales Header"."Final Destination")
//             {
//             }
//             column(txtPortOfDischarge; "Sales Header"."Port of Discharge")
//             {
//             }
//             column(txgprecarriage; "Sales Header"."Pre-Carriage")
//             {
//             }
//             column(txtreceiptbyprecarriage; "Sales Header".Carriage)
//             {
//             }
//             column(txtTypeAndPort; txtTypeAndPort)
//             {
//             }
//             column(txtPaymentTermDescription; txtPaymentTermDescription)
//             {
//             }
//             column(codLCNo; codLCNo)
//             {
//             }
...
//             {
//             }
//             column(txtAdditionalText; txtAdditionalText)
//             {
//             }
//             column(Invoice_No____DateCaption; Invoice_No____DateCaptionLbl)
//             {
//             }
//             column(Exporters_Ref_Caption; Exporters_Ref_CaptionLbl)
//             {
//             }
//             column(Buyer_s_Order_No____DateCaption; Buyer_s_Order_No____DateCaptionLbl)
//             {
//             }
//             column(Other_referencesCaption; Other_referencesCaptionLbl)
//             {
//             }
//             column(FINAL_EXPORT_INVOICE__SI_Caption; FINAL_EXPORT_INVOICE__SI_CaptionLbl)
//             {
//             }
...
//             {
//             }
//             column(DataItem1000000068;'')//We_declare_that_this_invoice_shows_the_actual_price_of_the_goods_described_and_that_all_particulars_are_true_and_correct_CaptLbl) //PCPL/NSW/MIG 09Aug22
//             {
//             } //PCPL-Deepak
...
//             {
//             }
//             column(ShipCust_Name; "Sales Header"."Ship-to Name")
//             {
//             }
//             column(ShipCust_Address; "Sales Header"."Ship-to Address" + ' ' + "Sales Header"."Ship-to Address 2")
//             {
//             }
...
//             {
//             }
//             column(UnderDrawback; "Sales Header"."Electronic Reference No.")
//             {
//             }
...
//                 {
//                 }
//                 column(Gross_Weight1; "Sales Line"."Gross Weight")
//                 {
//                 }
//                 column(Net_Weight1; "Sales Line"."Net Weight")
//                 {
//                 }
//                 column(Unitof_Measure; "Sales Line"."Unit of Measure")
//                 {
//                 }
...
//         recExportmentTerms : Record "Export Payment Terms";
...
//         recStuffHeader : Record "Commission Header";
