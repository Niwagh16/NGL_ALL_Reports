report 50049 "Delivary Challan NGL-Export"
{
    // version KAR1.00

    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\Delivary Challan NGL-Export.rdl';

    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            //DataItemTableView = WHERE("Export Document" = CONST(TRUE)); //PCPL/NSW/MIG 05Aug22
            ...
            dataitem("Sales Shipment Line"; "Sales Shipment Line")
            {
                ...
                column(Unit_Measure; "Sales Shipment Line"."Unit of Measure")
                {
                }
                column(Remarks_Comment; "Sales Shipment Header".Comment)
                {
                }
