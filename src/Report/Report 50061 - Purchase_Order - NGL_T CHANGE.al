report 50061 "Purchase_Order - NGL_T CHANGE"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\Purchase_Order - NGL_T CHANGE.rdl';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(pageLoop; Integer)
            {
                ...
                column(Range; '')//CompanyInfo."C.E. Range") PCPL/NSW/MIG 09Aug22
                {
                }
                column(Commissionarate; '')//CompanyInfo."C.E. Commissionerate") PCPL/NSW/MIG 09Aug22
                {
                }
                column(Division; '')//CompanyInfo."C.E. Division") PCPL/NSW/MIG 09Aug22
                {
                }
                column(Comp_ECC; '')//CompanyInfo."E.C.C. No.") PCPL/NSW/MIG 09Aug22
                {
                }
                ...
                column(pageLoop_user_TIN_No; '')//Location."T.I.N. No.") PCPL/NSW/MIG 09Aug22
                {
                }
                column(pageLoop_user_CST_No; '')//Location."C.S.T No.") PCPL/NSW/MIG 09Aug22
                {
                }
                column(pageLoop_user_ECC_No; '')//Location."E.C.C. No.") PCPL/NSW/MIG 09Aug22
                {
                }
                column(pageLoop_user_Range; '')//Location."C.E. Range") PCPL/NSW/MIG 09Aug22
                {
                }
                column(pageLoop_user_Division; '')//Location."C.E. Division") PCPL/NSW/MIG 09Aug22
                {
                }
                column(pageLoop_commissionerate; '')//Location."C.E. Commissionerate") PCPL/NSW/MIG 09Aug22
                {
                }
                ...
                column(PL_TaxAmount; '')// "Purchase Line"."Tax Amount") PCPL/NSW/MIG 09Aug22
                {
                }
                ...
                dataitem("Purchase Line"; "Purchase Line")
                {
                    ...
                    column(GST_PurchaseLine; '')//"Purchase Line"."GST %") PCPL/NSW/MIG 09Aug22
                    {
                    }
                    ...
                    column(PurchaseLine_ExciseAmount; '')//"Purchase Line"."Excise Amount")PCPL/NSW/MIG 09Aug22
                    {
                    }
                    column(Purchase_Line_Centera_Excise_Duty2; '')//"Purchase Line"."BED Amount") PCPL/NSW/MIG 09Aug22
                    {
                    }
                    ...
                    column(Purchase_Line_eCess_Amount; '')//"Purchase Line"."eCess Amount") PCPL/NSW/MIG 09Aug22
                    {
                    }
                    column(Purchase_Line_SHEd_Cess_of_BED; FORMAT('S & H Ed.Cess of B.E.D.') + ' ' + FORMAT(SHECESS) + ('%'))
                    {
                    }
                    column(Purchase_Line_SHE_Cess_Amount; '')//"Purchase Line"."SHE Cess Amount") PCPL/NSW/MIG 09Aug22
                    {
                    }
                    ...
                    column(Purchase_Line_Tax_Amount; '')//"Purchase Line"."Tax Amount") PCPL/NSW/MIG 09Aug22
                    {
                    }
                    ...
                    column(Purchase_Line_Amount_To_Vendor; '')//"Purchase Line"."Amount To Vendor") PCPL/NSW/MIG 09Aug22
                    {
                    }
                    ...
                    column(BED_Amount; '')//"Purchase Line"."BED Amount") PCPL/NSW/MIG 09Aug22
                    {
                    }
                    ...
                    begin
                        ...
                        // IF "Purchase Header"."C Form" = TRUE THEN //PCPL/NSW/MIG 09Aug22
            ...
            begin
                ...
                AmtToVend := 0;//("Purchase Header"."Amount to Vendor"); //PCPL/NSW/MIG 09Aug22
                CLEAR(Frght);
                CLEAR(Frght1);
                // "Purchase Header".CALCFIELDS("Amount to Vendor");
                ...
                *///pcpl
                ...
                // "Purchase Header"."No.");
                //IF "Purchase Header"."Transit Document" = FALSE THEN //PCPL/NSW/MIG 09Aug22
                ...
                IF Cust.FINDFIRST THEN BEGIN
                    VTIN := '';// Cust."T.I.N. No."; //PCPL/NSW/MIG 09Aug22
                    VCST := '';//Cust."C.S.T. No."; //PCPL/NSW/MIG 09Aug22
                END;
                /*
                CommentsLine.RESET;
