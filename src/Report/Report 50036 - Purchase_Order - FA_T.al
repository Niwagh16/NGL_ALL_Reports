report 50036 "Purchase_Order - FA_T"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\Purchase_Order - FA_T.rdl';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(Ven_Add; "Purchase Header"."Buy-from Address" + ',' + "Purchase Header"."Buy-from Address 2")
            {
            }
            column(Ven_city; "Purchase Header"."Buy-from City" + ',' + "Purchase Header"."Buy-from Post Code" + ',' + "Purchase Header"."Buy-from Country/Region Code")
            {
            }
            ...
            column(panno; CompanyInfo12."P.A.N. No.")
            {
            }
            ...
            column(GSTNO; CompanyInfo12."GST Registration No.")
            {
            }
            ...
            dataitem(pageLoop; Integer)
            {
                ...
                column(Ven_AddOLD; recVen.Address + ',' + recVen."Address 2")
                {
                }
                column(Ven_cityOLD; recVen.City + ',' + recVen."Post Code" + ',' + recVen."Country/Region Code")
                {
                }
                ...
                column(LoadingAndUnloading; "Purchase Header"."Loading/Unloading Charges")
                {
                }
            ...
            begin
                ...
                */
                ...
                IF "Purchase Header"."Order Address Code" <> '' THEN BEGIN
                    OrderAddress.RESET;
                    OrderAddress.SETRANGE(OrderAddress.Code, "Purchase Header"."Order Address Code");
                    IF OrderAddress.FINDFIRST THEN BEGIN
                        Contact := OrderAddress.Contact;
                        PhoneNo := OrderAddress."Phone No.";
                        Vendor_Email := OrderAddress."E-Mail";
                    END;
                END
                ELSE BEGIN
                    //PCPL-25
                    ...
                    Contact := "Purchase Header"."Buy-from Contact";    //PCPL-25
    ...
    var
        ...
        CompanyInfo12: Record "Company Information";
        add: Text;
        HSNCode: Text;
