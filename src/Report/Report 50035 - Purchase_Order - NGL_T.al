report 50035 "Purchase_Order - NGL_T"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\Purchase_Order - NGL_T.rdl';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(City_CompanyInfo; CompanyInfo.City + '-' + CompanyInfo."Post Code" + ' ' + ' Tel : ' + CompanyInfo."Phone No." + 'Email : ' + CompanyInfo."E-Mail" + '    URL:www.nglfinechem.com. CIN : ' + '')
            {
            }
            ...
            dataitem(pageLoop; Integer)
            {
                ...
                column(Vendor_Name; recVen.Name + ' ' + recVen."Name 2")
                {
                }
                ...
                column(pageLoop_address; CompanyInfo.Address + '  ' + CompanyInfo."Address 2" + ',' + CompanyInfo.City + '-' + CompanyInfo."Post Code" + ' ,Maharashtra,  ' + 'India.' + 'Tel No.022-26636450')
                {
                }
                column(Range; '')//CompanyInfo."C.E. Range") //PCPL/NSW/MIG  03Aug22
                {
                }
                column(Commissionarate; '')// CompanyInfo."C.E. Commissionerate") //PCPL/NSW/MIG  03Aug22
                {
                }
                column(Division; '')//CompanyInfo."C.E. Division") //PCPL/NSW/MIG  03Aug22
                {
                }
                column(Comp_ECC; '')//CompanyInfo."E.C.C. No.") //PCPL/NSW/MIG  03Aug22
                {
                }
                column(Company_Insurance_Policy_No; CompanyInfo."Insurance Policy No")
                {
                }
                column(CompanyGSTIN; 'GSTIN: ' + CompanyInformation."GST Registration No.")
                {
                }
                column(CompanyPAN; 'PAN: ' + CompanyInformation."P.A.N. No.")
                {
                }
                ...
                column(pageLoop_user_TIN_No; '')// Location."T.I.N. No.") //PCPL/NSW/MIG  03Aug22
                {
                }
                column(pageLoop_user_CST_No; '')//Location."C.S.T No.") //PCPL/NSW/MIG  03Aug22
                {
                }
                column(pageLoop_user_ECC_No; '')//Location."E.C.C. No.") //PCPL/NSW/MIG  03Aug22
                {
                }
                column(pageLoop_user_Range; '')// Location."C.E. Range") //PCPL/NSW/MIG  03Aug22
                {
                }
                column(pageLoop_user_Division; '')//Location."C.E. Division") //PCPL/NSW/MIG  03Aug22
                {
                }
                column(pageLoop_commissionerate; '')//Location."C.E. Commissionerate") //PCPL/NSW/MIG  03Aug22
                {
                }
                ...
                column(PL_TaxAmount; 0)//"Purchase Line"."Tax Amount") //PCPL/NSW/MIG  03Aug22
                {
                }
                ...
                column(Purchase_Quotation_No; "Purchase Header"."Quotation No")
                {
                }
                column(indentno; indentno)
                {
                }
                column(LoadingAndUnloadingCharge; "Purchase Header"."Loading/Unloading Charges")
                {
                }
                dataitem("Purchase Line"; "Purchase Line")
                {
                    ...
                    column(GST_PurchaseLine; 0)//"Purchase Line"."GST %") //PCPL/NSW/MIG  03Aug22
                    {
                    }
                    ...
                    column(Purchase_Line_Specification_Description; Descr)
                    {
                    }
                    ...
                    column(PurchaseLine_ExciseAmount; 0)// "Purchase Line"."Excise Amount") //PCPL/NSW/MIG  03Aug22
                    {
                    }
                    column(Purchase_Line_Centera_Excise_Duty2; 0)//"Purchase Line"."BED Amount") //PCPL/NSW/MIG  03Aug22
                    {
                    }
                    ...
                    column(Purchase_Line_eCess_Amount; 0)//"Purchase Line"."eCess Amount") //PCPL/NSW/MIG  03Aug22
                    {
                    }
                    column(Purchase_Line_SHEd_Cess_of_BED; FORMAT('S & H Ed.Cess of B.E.D.') + ' ' + FORMAT(SHECESS) + ('%'))
                    {
                    }
                    column(Purchase_Line_SHE_Cess_Amount; 0)//"Purchase Line"."SHE Cess Amount") //PCPL/NSW/MIG  03Aug22
                    {
                    }
                    ...
                    column(Purchase_Line_Tax_Amount; 0)//"Purchase Line"."Tax Amount") //PCPL/NSW/MIG  03Aug22
                    {
                    }
                    ...
                    column(Purchase_Line_Amount_To_Vendor; 0)// "Purchase Line"."Amount To Vendor") //PCPL/NSW/MIG  03Aug22
                    {
                    }
                    ...
                    column(BED_Amount; 0)//"Purchase Line"."BED Amount") //PCPL/NSW/MIG  03Aug22
                    {
                    }
                    ...
                    begin
                        //PCPL-25
                        CLEAR(HSNCode);
                        IF "Purchase Line"."GST Group Type" = "Purchase Line"."GST Group Type"::Goods THEN
                            HSNCode := 'G-' + "Purchase Line"."HSN/SAC Code"
                        ELSE
                            HSNCode := 'S-' + "Purchase Line"."HSN/SAC Code";
                        //PCPL-25
                        //MS
                        CLEAR(LineAmt);
                        CLEAR(LineDisc);
                        ...
                        */ //PCPL/NSW/MIG  03Aug22 
                        ...
                        //StrOrdDet1.SETRANGE("Tax/Charge Type", StrOrdDet1."Tax/Charge Type"::Charges); //PCPL/NSW/MIG  03Aug22
                        ...
                        //PCPL/BRB>>
                        IF Item_rec.GET("Purchase Line"."No.") THEN;
                        IF ("Purchase Line"."Item Category Code" = 'RMIND') OR ("Purchase Line"."Item Category Code" = 'RMIMP') OR ("Purchase Line"."Item Category Code" = 'CONS') OR ("Purchase Line"."Item Category Code" = 'SFG') THEN
                            Descr := "Purchase Line"."Description 2"
                        ELSE
                            Descr := "Purchase Line".Description;
                        //PCPL/BRB<<
                       ...
                       */
                        ...
                        */
                        ...
                        IF ITM.GET("Purchase Line"."No.") THEN BEGIN
                            NODES := ITM."Description 2";
                            Variance := ITM."Tolerance %"; //pcpl/brb
                        END;
                        //Gunjan-End
                ...
                begin
                    ...
                    */
                    ...
                    IF Location.FINDFIRST THEN BEGIN
                        ...
                        loctin := '';//Location."T.I.N. No."; //PCPL/NSW/MIG  03Aug22
                        loccst := '';//Location."C.S.T No."; //PCPL/NSW/MIG  03Aug22
                        locecc := '';//Location."E.C.C. No."; //PCPL/NSW/MIG  03Aug22
                        locser := '';//Location."Service Tax Registration No."; //PCPL/NSW/MIG  03Aug22
                        locrang := '';//Location."C.E. Range"; //PCPL/NSW/MIG  03Aug22
                        locdivision := '';//Location."C.E. Division"; //PCPL/NSW/MIG  03Aug22
                        loccom := '';//Location."C.E. Commissionerate"; //PCPL/NSW/MIG  03Aug22
                        ...
                        IF ven.FINDFIRST THEN BEGIN
                            VTIN := '';//ven."T.I.N. No."; //PCPL/NSW/MIG  03Aug22
                            VCST := '';//ven."C.S.T. No."; //PCPL/NSW/MIG  03Aug22
                            VECC := '';//ven."E.C.C. No."; //PCPL/NSW/MIG  03Aug22
                            VPAN := ven."P.A.N. No.";
                            VRANGE := '';//ven.Range;//PCPL/NSW/MIG  03Aug22
                            VDIV := '';//ven.Collectorate; //PCPL/NSW/MIG  03Aug22
            ...
            begin
                //PCPL-25
                add := CompanyInformation.Address + ' ' + CompanyInformation."Address 2" + ' ' + CompanyInformation.City + '-' + CompanyInformation."Post Code" + '. ' +
                 CompanyInformation."Country/Region Code" + '. Tel:' + ''/*CompanyInformation."STD Code"*/ + '-' + CompanyInformation."Phone No." + '. Email:' + CompanyInformation."E-Mail" + ', URL:' +
                CompanyInformation."Home Page" + '. CIN:' + ''/*CompanyInformation."Company Registration  No."*/ + '.';
                //PCPL-25
                //301, E-Square,Subhash Road, Vile Parle(East), Mumbai-400057. India. Tel:022-26636450. Email : purchase@nglfinechem.com,URL:www.nglfinechem.com. CIN : L24110MH1981PLC025884.

                //PCPL0024_04Feb2019
                PL.RESET;
                PL.SETRANGE(PL."Document No.", "No.");
                PL.SETRANGE(PL."No.", 'FNO0005');
                IF PL.FINDFIRST THEN BEGIN
                    Statement6 := 'In case of Purchase of Imported Coal, short receipt of material >1% of the net quantity will be to vendors account and will be deducted from their invoice.';
                END
                ELSE BEGIN
                    Statement6 := 'In case of bulk purchases in tankers, short receipt of material >0.5% of the net quantity will be to vendors account and will be deducted from their invoice.';
                END;
                //PCPL0024_04Feb2019
                ...
                IF PL.FINDSET THEN
                    ...
                    UNTIL PL.NEXT = 0;
                //"Purchase Header".CALCFIELDS("Amount to Vendor"); //PCPL/NSW/MIG  03Aug22
                AmtToVend := 0;// ("Purchase Header"."Amount to Vendor"); //PCPL/NSW/MIG  03Aug22
                CLEAR(Frght);
                CLEAR(Frght1);
                //"Purchase Header".CALCFIELDS("Amount to Vendor"); //PCPL/NSW/MIG  03Aug22
                ...
                *///pcpl
                ...
                END;
                //pcpl002409jan2019
                /*//pcpl0024 temp comment 09-jan2019
                Comments[i] := '';
                i:=0;
                PurchaseComments.RESET;
                PurchaseComments.SETRANGE(PurchaseComments."Document Type", PurchaseComments."Document Type"::Order);
                PurchaseComments.SETRANGE(PurchaseComments."No.","Purchase Header"."No.");
                IF PurchaseComments.FINDFIRST THEN
                BEGIN
                  REPEAT
                  i:=i+1;
                    Comments[i] := Comments[i] + ' ' + PurchaseComments.Comment;
                  UNTIL PurchaseComments.NEXT =0;
                END;
                */
                ...
                "Transit Document Order Details".SETFILTER("Transit Document Order Details"."PO / SO No.",
                "Purchase Header"."No.");
                //IF "Purchase Header"."Transit Document" = FALSE THEN //PCPL/NSW/MIG  03Aug22
                ...
                */  //PCPL/NSW/MIG  03Aug22
                ...
                IF Cust.FINDFIRST THEN BEGIN
                    VTIN := '';//Cust."T.I.N. No."; //PCPL/NSW/MIG  03Aug22
                    VCST := '';// Cust."C.S.T. No."; //PCPL/NSW/MIG  03Aug22
                END;
                /*
                CommentsLine.RESET;
