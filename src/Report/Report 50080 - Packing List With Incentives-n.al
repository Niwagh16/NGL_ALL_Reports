// report 50080 "Packing List With Incentives-n"
// {
//     // version PCPL //PCPL/NSW/MIG 09Aug22

//     DefaultLayout = RDLC;
//     RDLCLayout = 'src/Packing List With Incentives-n.rdl';
//     UseRequestPage = true;
...
//                     {
//                     }
//                     column(HsCode; 'HS Code:' + FORMAT(HSCode))
//                     {
//                     }
...
//                     {
//                     }
//                     column(CountryName_Customer; CountryRegion.Name)
//                     {
//                     }
//                     column(BilltoCountryName; CustCountry)
//                     {
//                     }
...
//                     begin
//                         //ADDED CODE FOR PCPL 0028   070218
//                         /*
//                         recItem.RESET;
//                         recItem.SETRANGE(recItem."No.","Packing List Package Details"."Item No.");
//                         IF recItem.FINDFIRST THEN BEGIN
//                         //repeat
//                               IF (PrevHSN<> recItem."HSN/SAC Code") THEN BEGIN
//                            HSCode:=HSCode +' ' + recItem."HSN/SAC Code";
//                            HSNCode:=  recItem."HSN/SAC Code";
//                         //   MESSAGE(FORMAT(HSCode));
//                            END;
//                           //until recitem.next=0;
//                           PrevHSN:=  recItem."HSN/SAC Code";
//                         END;
//                         //close pcpl 0028 070218
//                          */
...
//                             HSCode := recItem."HSN/SAC Code"; //Added Code PCPL 0028
...
//                             IF ProductGroup.GET(Itemrec."Item Category Code", Itemrec."Product Group Code") THEN
...
//                          ItemNo := "Item No.";
//                          itemdescprodgrouptex := ProductGroup.Description;
//                          ItemDescr := "Packing List Package Details"."Item Description";
//                        END;
//                        */
//                         CLEAR(decNetWeight);
...
//                     {
//                     }
//                     dataitem(DataItem1000000056; Table280)
//                     {
...
//                     trigger OnPreDataItem();
//                     begin
//                         SETRANGE(Number, 1, 20 - CountPack);
//                     end;
//                 }
...
//                     IF "Packing List Header".Status = "Packing List Header".Status::Shipped THEN BEGIN
//                         ShipmentMethod := "Packing List Header"."Shipment Method Code";
//                         SalesInvHeader.RESET;
//                         SalesInvHeader.SETRANGE(SalesInvHeader."Order No.", "Packing List Header"."SO NO.");
...
//                         ShipmentMethod := SalesHeader."Shipment Method Code";
//                     END;

//                     IF recCompanyInfo.GET(recCompanyInfo."Primary Key") THEN BEGIN
//                         cduFormatAddr.Company(txtCompanyAddr, recCompanyInfo)
//                     END;
//                     IF recPortsport.GET("Packing List Header".Port) THEN
//                         txtPortName := recPortsport."Port Name";
...
//                     //PCPL0041-End-04022020

//                     /*
//                     IF "Packing List Header"."Bill-to Customer No."<>'' THEN BEGIN
//                       //fctPackingListBillTo(txtBillToCust,"Packing List Header");  ///
//                          txtBillToCust[1]:= "Packing List Header"."Bill-to Name";
//                          txtBillToCust[2]:= "Packing List Header"."Bill-to Name 2";
//                          txtBillToCust[3]:= "Packing List Header"."Bill-to Address";
//                          txtBillToCust[4]:= "Packing List Header"."Bill-to Address 2";
//                          txtBillToCust[5]:= "Packing List Header"."Bill-to City";
//                          txtBillToCust[6]:= "Packing List Header"."Bill-to Contact";
//                          txtBillToCust[7]:= "Packing List Header"."Bill-to Post Code";
//                          //PCPL0041-Start-28012020
//                          //txtBillToCust[8]:= "Packing List Header"."Bill-to Country Code";
//                          CounReg.RESET;
//                          CounReg.SETRANGE(Code,"Packing List Header"."Bill-to Country Code");
//                          IF CounReg.FINDFIRST THEN
//                            txtBillToCust[8]:= CounReg.Name;
//                          //PCPL0041-End-28012020
//                     END;
//                     */

//                     IF recPorts.GET("Port of Discharge") THEN
//                         txtPortofDischarge := recPorts."Port Name";
...
//                     IF Customerrec.GET("Sell-to Customer No.") THEN      //PCPL/BRB
//                         IF CountryRegion.GET(Customerrec."Country/Region Code") THEN
//                             CustCountry := CountryRegion.Name;
//                     IF RecShiptocode.GET("Sell-to Customer No.", "Ship-to Code") THEN
//                         IF CountryRegion.GET(RecShiptocode."Country/Region Code") THEN;
...
//         txtCompanyAddr: array[8] of Text[90];
...
//         txtBillToCust: array[8] of Text[80];
//         MfgDrugLic: Code[50];
...
//         Descr2: Text;
//         ItemNo: Code[55];
//         RecPackingListHeader: Record "33001046";
//         RecPackingListPackDetail: Record "33001048";
//         PrevHSN: Text[100];
//         HSNCode: Text[100];
//         CounReg: Record "9";
...
//     procedure fctPackingListSellTo(var PtxtAddrArray: array[8] of Text[90]; var PrecPackingList: Record "33001046");
//     begin
...
//     procedure fctPackingListShptTo(var PtxtAddrArray: array[8] of Text[90]; var PrecPackingList: Record "33001046");
//     begin
//         WITH PrecPackingList DO
//             cduFormatAddr.FormatAddr(
...
//     procedure fctPackingListBillTo(var PtxtAddrArray: array[8] of Text[90]; var PrecPackingList: Record "33001046");
//     begin
//         WITH PrecPackingList DO
//             cduFormatAddr.FormatAddr(
