report 50004 "NGL - Sales Quotes(Export)"
{
    // version KAR1.0

    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\NGL - Sales Quotes(Export).rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(BUyercity_Postcode; "Sales Header"."Bill-to City" + ',' + "Sales Header"."Sell-to Post Code" + ',' + BillToCust)
            {
            }
            ...
            column(ShipToPostal; "Sales Header"."Ship-to City" + ',' + "Sales Header"."Ship-to Post Code" + ',' + SelltoCust)
            {
            }
            ...
            begin
                ...
                IF RecCustomer.GET("Sales Header"."Bill-to Customer No.") THEN BEGIN
                    IF CountryRegion.GET(RecCustomer."Country/Region Code") THEN
                        BillToCust := CountryRegion.Name;
                END;
                IF CountryRegion.GET("Sales Header"."Ship-to Country/Region Code") THEN
                    SelltoCust := CountryRegion.Name;
                //to add port name instead of port code.
    ...
    var
        ...
        //RecPort : Record "33001050"; //PCPL-Deepak
