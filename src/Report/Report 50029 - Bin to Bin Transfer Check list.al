report 50029 "Bin to Bin Transfer Check list"
{
    // version NAVW17.10,KAR1.0

    DefaultLayout = RDLC;
    RDLCLayout = 'src\Report Layout\Bin to Bin Transfer Check list.rdl';
    ...
    dataset
    {
        dataitem("Warehouse Entry"; "Warehouse Entry")
        {
            ...
            column(Unit_Of_Measure; "Warehouse Entry"."Unit of Measure Code")
            {
            }
    ...
    var
        ...
        RecInspectionDataSheet: Record "Posted Inspection";
        OldBinCode: Code[20];
        OldLocCode: Code[10];
        FilterDate: Text[30];
        "Filter": Text[1024];
