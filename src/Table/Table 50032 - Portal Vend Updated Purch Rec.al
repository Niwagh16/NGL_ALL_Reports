table 50032 "Portal Vend Updated Purch Rec"
{
    // version pcpl0026/AN
    ...
    var
        ...
        RecQuatationRecived: Record 50032;
        OutStr: OutStream;
        InStr: InStream;
        Recref: RecordRef;
    ...
    begin
        ...
        IF PortalVendUpdatedPurchRec.FINDFIRST THEN BEGIN
            ...
            // PurchaseHeader.VALIDATE(Structure, 'GST');//PCPL/NSW/MIG  25July22
            IF ("Freight Charges" <> 0) OR ("Packing & Forwarding Charges" <> 0) THEN
                //  PurchaseHeader.VALIDATE(Structure, 'GST+FR+PC');  //PCPL/NSW/MIG  25July22
    ...
    begin
        ...
        IF Recpurchaserheader.FINDFIRST THEN BEGIN
                    ...
                    IF recitem.FINDFIRST THEN BEGIN
                        ...
                        IF recspecificationheader.FINDFIRST THEN BEGIN
                            ...
                            */ //NSW07
                            ...
                            Emailmessage.AddAttachment('Specification', '.pdf', InStr);
                            //path := 'D:\New folder (2)';
            ...
            BodyText.AddText('<table border="0">');
            BodyText.AddText('<tr>');
            BodyText.AddText('<th> Broker Name:' + RecVendor."Broker Name" + '</th>');
            BodyText.AddText('</tr>');
            BodyText.AddText('<br><Br>');
            BodyText.AddText('<br><Br>');
            BodyText.AddText('<br><Br>');
